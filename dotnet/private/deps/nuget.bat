...
bazel run //tools/nuget2bazel:nuget2bazel.exe -- add -p c:/rules_dotnet/dotnet/private/deps -b nuget.bzl -c nuget.json -i System.Reflection.MetadataLoadContext 4.7.1
