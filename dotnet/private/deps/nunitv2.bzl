...
def dotnet_repositories_nunitv2():
    ...
    nuget_package(
        ...
        core_lib = {
            ...
            "netcoreapp3.0": "tools/lib/nunit-console-runner.dll",
            "netcoreapp3.1": "tools/lib/nunit-console-runner.dll",
        },
        net_lib = {
            ...
            "net48": "tools/lib/nunit-console-runner.dll",
            ...
            "netstandard2.1": "tools/lib/nunit-console-runner.dll",
        },
