...
nuget_package(
   ...
   package = "ninject",
   version = "3.3.4",
   sha256 = "5bb83b73785999140ba84141468892d9d8dff84c1e03a5f30e76acba1df6fbd8",
   core_lib = "lib/netstandard2.0/Ninject.dll",
   net_lib = "lib/net45/Ninject.dll",
   mono_lib = "lib/net45/Ninject.dll",
   core_deps = [
       "@io_bazel_rules_dotnet//dotnet/stdlib.core:system.reflection.emit.ilgeneration.dll",
       "@io_bazel_rules_dotnet//dotnet/stdlib.core:system.reflection.emit.lightweight.dll",
   ],
   net_deps = [
   ],
   mono_deps = [
   ...
   core_files = [
       ...
       "lib/netstandard2.0/Ninject.xml",
   ],
   net_files = [
       "lib/net45/Ninject.dll",
       "lib/net45/Ninject.xml",
   ],
   mono_files = [
       "lib/net45/Ninject.dll",
       "lib/net45/Ninject.xml",
